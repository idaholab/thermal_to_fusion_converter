...
#-----------------
def get_abs_flux():
    with open('atr_spectrum/energy_breakdown_atr.csv','r') as f:
        csv_reader = csv.DictReader(f)
        flux = {}
        for row in csv_reader:
           flux[row['position']]=float(row['total flux'])
    return flux
#-----------------
...
if __name__ == "__main__":
    ...
    run_geant = True  
    use_pbs = False # all calculations will be performed in parallel
    ...
    material_list =  ['He3D2_1','He3D2_2','He3D2_3']
                    #   'LiOD_D2O_10','LiOD_D2O_20','LiOD_D2O_30',
                    #   'Li6OD_D2O_10','Li6OD_D2O_20','Li6OD_D2O_30']

    
    #['Li6D','LiD','Li6AlD4','LiAlD4','Li6OD_D2O','LiOD_D2O','He3D2']
    #position_list =  ['A11','NEFT','B5','B11','I14','I11','OS5','OS15']
    position_list =  ['A11','OS15']

    #get the total neutron flux per position (n/cm2/s)
    tot_flux = get_abs_flux()
    ...
    for position in position_list:
        ...
        for material in material_list:
            ...
            for run in range(number_of_runs):
                ...
                change_input.append(('material',material))
            ...
            if postprocess_geant:
                ...
                total_yield = spectrum_atr + converter_yield
                ...
                writer2.writerow([position,
                                material,
                                spectrum_atr,#*tot_flux[position],
                                spectrum_in_target,#*tot_flux[position],
                                increase])
    if postprocess_geant:
        f1.close()
        f2.close()
