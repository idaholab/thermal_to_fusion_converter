...
if __name__ == "__main__":
    ...
    energy_cutoff = 10 # 1e-11 #0.5 # MeV - for defining yield
    breeder_material_list = ['Li6D']
    thickness_mm={}
    thickness_mm['Li6D'] = 1.
    thickness_mm['LiD'] = 2. 
    ...
    position_list = ['NEFT']
    shielding_material_list = ['Water']
    shielding_thickness_list = ['001','005','010','050','090']
    ...
    if postprocess_geant:
        ...
        columns=['position','breeder breeder_material','shielding breeder_material',
                'converter',
                'D-T ', 
                'Li-T', 
                'triton',  
    ...
    #-------
    # loop over breeding breeder_materials 
    #-------
    for breeder_material in breeder_material_list:
        print ('breeder_material = {}'.format(breeder_material))

        #--------
        #loop over positions 
        #--------
        for breeder_material,position,shielding_material,shielding_thickness in zip(breeder_material_list,position_list,shielding_material_list,shielding_thickness_list):
            ...
            #rundir =  base_pwd / 'run_{}'.format(breeder_material)
            ...
            for run in range(number_of_runs):
                ...
                rundir = base_pwd / breeder_material / position / shielding_material / shielding_thickness 
                ...
                change_input.append(('hist_ene.txt','hist_ene_{}_{}_{}.txt'.format(position,shielding_material,shielding_thickness)))
                change_input.append(('breeder_material',breeder_material))
                change_input.append(('breeder_thickness',thickness_mm[breeder_material]))
                radius = 7+thickness_mm[breeder_material] # 5 mm inner radius, 1 mm inner/outer cladding
                change_input.append(('source_radius',radius))
                halfz = 27+thickness_mm[breeder_material]
            ...
            if postprocess_geant:
                ...
                # with open('results_per_run_{}_{}_{:.1f}.csv'.format(breeder_material,position,energy_cutoff),'w',newline='') as file:
