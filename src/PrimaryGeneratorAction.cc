...
{
  G4cout << "SetDefaultKinematic disabled with GPS" << G4endl;
 // G4ParticleDefinition* particle
 //         = G4ParticleTable::GetParticleTable()->FindParticle("e-");
 // fG4GeneralParticleSource->SetParticleDefinition(particle);
 // fG4GeneralParticleSource->SetEnergy(500*keV);  
 // fG4GeneralParticleSource->SetParticleMomentumDirection(G4ThreeVector(1.,0.,0.));
